...
namespace AlphaGymBackend.Services.Hikvision
{
    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public const int NET_DVR_SET_WIFI_CFG = 306;//设置IP_设备无线参数
        public const int NET_DVR_GET_WIFI_CFG = 307;//获取IP_设备无线参数
        public const int NET_DVR_SET_WIFI_WORKMODE = 308;//设置IP_设备网口工作模式参数
        public const int NET_DVR_GET_WIFI_WORKMODE = 309;//获取IP_设备网口工作模式参数 
        public const int NET_DVR_GET_WIFI_STATUS = 310;	//获取设备当前wifi连接状态

        /***************************智能服务器 begin *****************************/
        //智能设备类型
        public const int DS6001_HF_B = 60;//异常行为检测：DS6001-HF/B
        public const int DS6001_HF_P = 61;//车牌识别：DS6001-HF/P
        public const int DS6002_HF_B = 62;//双机_：DS6002-HF/B
        public const int DS6101_HF_B = 63;//异常行为检测：DS6101-HF/B
        ...
        public const int VCA_CHAN_ABILITY = 272;//异常行为检测能力
        ...
        public const int NET_DVR_SET_RULECFG = 152;//设置异常行为检测规则
        public const int NET_DVR_GET_RULECFG = 153;//获取异常行为检测规则
        ...
        public const int NET_VCA_GET_RULECFG_V41 = 5011; //获取异常行为检测参数
        public const int NET_VCA_SET_RULECFG_V41 = 5012; //设置异常行为检测参数
        ...
        // Door Control Commands (for NET_DVR_ControlGateway dwStaic)
        public const uint NET_DVR_CLOSE_DOOR = 0;
        public const uint NET_DVR_OPEN_DOOR = 1;
        public const uint NET_DVR_STAY_OPEN_DOOR = 2;
        public const uint NET_DVR_STAY_CLOSE_DOOR = 3;
        ...
        public const int COMM_ALARM_RULE = 0x1102;//异常行为检测报警信息，对应NET_VCA_RULE_ALARM
        ...
        public const int COMM_SNAP_MATCH_ALARM = 0x2902;  //非准入名单比对结果上传
        ...
        **************************************************/
        ...
        public const int WARNONMONITOR = 0x1;/*显示器上警告*/
        ...
        public struct NET_DVR_ALARMINFO_V40
       {
        ...
        public struct NET_DVR_DEV_CHAN_INFO
        {
            ...
            public byte[] byDomain;	//设备域名
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] sUserName;	//_主机登陆帐号
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = PASSWD_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] sPassword;	//_主机密码
        }
        ...
        public struct NET_DVR_DEVICEINFO_V40
        {
            ...
            public byte byPasswordLevel;      //admin密码安全等级0-无效，1-默认密码，2-有效密码,3-风险较高的密码。当用户的密码为出厂默认密码（_）或者风险较高的密码时，上层客户端需要提示用户更改密码。      
        ...
        public struct NET_VCA_DEV_ABILITY
        {
            ...
            public byte bySupport;            //能力，位与结果为0表示不支持，1表示支持
            //bySupport & 0x1，表示是否支持智能_ 2012-3-22
            ...
            public byte byFSnapBFullChanNum;  //人脸抓拍和异常行为检测通道个数
        ...
        public struct NET_VCA_ONE_RULE
        {
            ...
            public VCA_EVENT_TYPE dwEventType;//异常行为检测事件类型
        ...
        public struct NET_DVR_TRACK_CFG
        {
            ...
            public byte byDomeCalibrate;			//设置智能_球机标定，1设置 0不设置 
            public byte byRes;					// 保留字节
        ...
        {
            public uint dwSize;		//结构长度
            public byte byTrackMode;   //_模式
            public byte byRuleConfMode;   //规则配置_模式0-本地配置_，1-远程配置_
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;   //保留，置0
            [StructLayout(LayoutKind.Sequential)]
        ...
        public struct NET_DVR_VCA_CTRLINFO_CFG
        {
            ...
            public byte byVCAType;       //智能能力类型，VCA_CHAN_ABILITY_TYPE 
            public byte byStreamWithVCA; //码流中是否带智能信息
            public byte byMode;			//模式，ATM 能力时参照VCA_CHAN_MODE_TYPE ,TFS 能力时参照 TFS_CHAN_MODE_TYPE，异常行为检测完整版时参照BEHAVIOR_SCENE_MODE_TYPE
            public byte byControlType;   //控制类型，按位表示，0-否，1-是
	                        //byControlType &1 是否启用抓拍功能
        ...
        public struct NET_DVR_POSITION_RULE_CFG_V41
        {
            ...
            public byte byTrackEnable; //是否启用_
            public byte byRes1;
            public ushort wTrackDuration; //_持续时间，单位s
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 76, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;         // 保留字节
        }
        ...
        public struct NET_DVR_TRACK_PARAMCFG
        {
            ...
            public ushort wTrackHoldTime;     // 报警_持续时间  范围0-300秒
            public byte byTrackMode;        //  参照 IPDOME_TRACK_MODE
            public byte byPreDirection;	// _方向预判 0-不启用 1-启用
            public byte byTrackSmooth;	    // _连续  0-不启用 1-启用
            public byte byZoomAdjust;	// 倍率系数调整 参见下表
            public byte byMaxTrackZoom;	//最大_倍率系数,0-表示默认倍率系数,等级6-标定值*1.0(默认),1-5为缩小标定值，值越小，缩小的比例越大,7-15为放大，值越大，放大的比例越大
            public byte byStopTrackWhenFindFace;  //人脸检测到后是否停止_ 0-否 1-是
            public byte byStopTrackThreshold;   //_终止评分阈值
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 9, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;          //  保留字节                
        }
        ...
        public enum TRAFFIC_AID_TYPE
        {
            ...
            SMOKE                 = 0x20,    //烟雾  
	        OVERLINE              = 0x40,     //压线
	        VEHICLE_CONTROL_LIST  = 0x80,  //非准入名单数据
	        SPEED                 = 0x100  //超速
        }
        ...
        public enum ITS_ABILITY_TYPE
        {
	        ...
	        ITS_VEHICLE_CONTROL_LIST_ABILITY   = 0x80,		//非准入名单数据
        ...
        {    
            ...
            public NET_DVR_PTZPOS struPtzPos;       //ptz 坐标
            public uint dwTrackTime;              //球机_时间[5,300] 秒，TFS(交通取证)模式下有效
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 24, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;               //保留
        }
        ...
        public struct NET_DVR_PLATE_INFO
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_LICENSE_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byBelieve; //各个识别字符的置信度，如检测到车牌"浙A_", 置信度为,20,30,40,50,60,70，则表示"浙"字正确的可能性只有%，"A"字的正确的可能性是%
        }
        ...
        public struct NET_DVR_WHITEBALANCE
        {
            public byte byWhiteBalanceMode; /*0-手动白平衡（MWB）,1-自动白平衡1（AWB1）,2-自动白平衡2 (AWB2),3-自动控制改名为锁定白平衡(Locked WB)，
	                         ...
	                         8-自动_(Auto-Track)9-一次白平衡(One Push)，10-室外自动(Auto-Outdoor)，
       ...
       public enum NET_SDK_DOWNLOAD_STATUS
       {
        ...
        public struct NET_MATRIX_RESOURSEGROUPPARAM
        {
            ...
            public byte byGroupType;/*0-摄像机CAM组，1-显示器MON组*/
            public byte byRes1;
        ...
        public struct NET_DVR_MATRIXMANAGE_ABIILITY
        {
            ...
            public uint dwMaxMonitorNum;//最大显示器数量
        ...
        {
            public byte byAgeGroup;    //年龄段,参见 HUMAN___GROUP_ENUM
            ...
            public byte byBeard;  //_, 0-不支持，1-没有_，2-有_，0xff-unknow表示未知,算法支持未检出
            public byte byRace;  //_, 0-不支持，1-亚洲人，2-_，3-_,0xff-unknow表示未知,算法支持未检出
        ...
        public struct NET_VCA_HUMAN_ATTRIBUTE
        {
            ...
            public byte byAgeGroup;//年龄段，详见HUMAN___GROUP_ENUM，如传入0xff表示未知
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 11, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;//保留
        }
        ...
        public struct NET_VCA_BLOCKLIST_PARA
        {
            ...
            public uint dwRegisterPicNum;  //非准入名单图个数
        ...
        public struct NET_VCA_BLOCKLIST_COND
        {
            public Int32 lChannel; //通道号
            public uint dwGroupNo; //分组号
            public byte byType; //黑准入名单标志：0-全部，1-准入名单，2-非准入名单
            public byte byLevel; //非准入名单等级，0-全部，1-低，2-中，3-高
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;  //保留
            public NET_VCA_HUMAN_ATTRIBUTE struAttribute; //人员信息
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
        ...
        public struct NET_VCA_FACESNAP_INFO_ALARM
        {
            ...
            public byte byAgeDeviation;//年龄误差值
            public byte byAgeGroup;//年龄段，详见HUMAN___GROUP_ENUM，若传入0xff表示未知
        ...
        public struct NET_VCA_BLOCKLIST_INFO_ALARM
        {
            ...
            public uint dwBlockListPicLen;       //非准入名单人脸子图的长度，为0表示没有图片，大于0表示有图片
        ...
        public struct NET_VCA_FACESNAP_MATCH_ALARM
        {
            ...
            public NET_VCA_BLOCKLIST_INFO_ALARM struBlockListInfo; //非准入名单信息
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
            public byte[] sStorageIP;        //存储服务IP地址
            public ushort wStoragePort;            //存储服务端口号
        ...
        public struct NET_VCA_FACESNAP_MATCH_ALARM_LOG
        {
            ...
            public NET_VCA_BLOCKLIST_INFO_ALARM_LOG struBlockListInfoLog; //非准入名单信息
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 60, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              // 保留字节
        }
        ...
        public struct NET_VCA_FACEMATCH_PICCOND
        {
            ...
            public uint dwBlockListID; //匹配的非准入名单ID
            public uint dwBlockListFaceID; //比对的非准入名单人脸子图ID
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              // 保留字节
        }
        ...
        public struct NET_VCA_FACEMATCH_PICTURE
        {
            ...
            public uint dwBlockListFaceLen; //比对的非准入名单人脸子图长度
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              //保留字节
            public IntPtr pSnapFace;  //抓拍人脸子图的图片数据
            public IntPtr pBlockListFace;  //比对的非准入名单人脸子图数据
        }
        ...
        {
            public uint dwSize;   //结构大小
            public NET_VCA_BLOCKLIST_INFO struBlockListInfo;  //非准入名单基本参数
        ...
        public struct NET_VCA_SINGLE_PATH
        {
            ...
            public byte byType;   //0-存储抓拍，1-存储非准入名单比对报警，2-存储抓拍和非准入名单比对报警，0xff-无效
        ...
        public struct NET_ITS_PLATE_RESULT
        {
            ...
            //0-开闸，1-未开闸 (专用于历史数据中相机根据黑准入名单匹配后，是否开闸成功的标志)
        ...
        public struct NET_DVR_DIAGNOSIS_UPLOAD
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 64)]
            public string sMonitorIP;  ///< _点ip
            public uint dwChanIndex;  ///< _点通道号  
        ...
        public struct NET_DVR_ACS_EVENT_INFO
        {
            ...
            public byte byCardType; //卡类型，1-普通卡，2-_卡，3-非准入名单卡，4-巡更卡，5-胁迫卡，6-超级卡，7-来宾卡，为0无效
        ...
        public struct NET_DVR_ID_CARD_INFO
        {
            ...
            public byte byNation;    //_，1-"汉"，2-"蒙古"，3-"回",4-"藏",5-"维吾尔",6-"苗",7-"彝",8-"壮",9-"布依",10-"朝鲜",
        ...
        public struct NET_DVR_ID_CARD_INFO_ALARM
        {
            ...
            public uint dwPicDataLen;   //图片数据大小，不为0是表示后面带数据
            public IntPtr pPicData;
            public byte byCardType; //卡类型，1-普通卡，2-_卡，3-非准入名单卡，4-巡更卡，5-胁迫卡，6-超级卡，7-来宾卡，8-解除卡，为0无效
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            public byte byCardType; //卡类型，1-普通卡，2-_卡，3-非准入名单卡，4-巡更卡，5-胁迫卡，6-超级卡，7-来宾卡，8-解除卡，9-员工卡，10-应急卡，11-应急管理卡（用于授权临时卡权限，本身不能开门），默认普通卡
        ...
        public enum IVS_PARAM_KEY
        {
            ...
            MISSING_OBJECT_HOLD = 7,//目标消失后继续_时间
            MAX_MISSING_DISTANCE = 8,//目标消失后继续_距离
        ...
        public struct NET_DVR_LF_TRACK_MODE
        {
            ...
            public struct uModeParam
            {
                ...
                public uint[] dwULen;
                /*
                public NET_DVR_LF_MANUAL_CTRL_INFO struManualCtrl;//手动_结构
                public NET_DVR_LF_TRACK_TARGET_INFO struTargetTrack;//目标_结构
                 * */
            }
        }
        ...
        */
        ...
        public struct NET_VCA_PLATE_INFO
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = MAX_LICENSE_LEN)]
            public string sBelieve;//各个识别字符的置信度，如检测到车牌"浙A_", 置信度为10,20,30,40,50,60,70，则表示"浙"字正确的可能性只有10%，"A"字的正确的可能性是20%
        }
